...
INSERT INTO products(article_number, quantity_sim_cards, release_date, weight,
                     ...
                     engine_power, engine_type, guarantee, image, memory, name, os, price, processor, program_training,
...
VALUES (1235, 2, CAST('2022-02-23' AS DATE), 187, 1, 1, 'APPLE', 'SMARTPHONES', 'WHITE',
        ...
        NULL, NULL, NULL, NULL, 'TWO_HUNDRED_FIFTY_SIX_GB', 'IPhone 15 pro', 'IOS', 169.999, 'Apple A15 Bionic', NULL,
       ...
       (5432, 1, CAST('2023-07-10' AS DATE), 187, 1, 2, 'SAMSUNG', 'SMARTPHONES', 'RED',
        ...
        NULL, NULL, NULL, NULL, 'TWO_HUNDRED_FIFTY_SIX_GB', 'Samsung Galaxy Z Flip5', 'ANDROID', 109.999, 'Qualcomm Snapdragon 8 Gen2', NULL,
       ...
       (7868, 2, CAST('2022-05-08' AS DATE), 178, 1, 3, 'HONOR', 'SMARTPHONES', 'RED',
        ...
        NULL, NULL, NULL, NULL, 'TWO_HUNDRED_FIFTY_SIX_GB', 'Honor 70', 'ANDROID', 49.000, 'Qualcomm Snapdragon 778G Plus', NULL,
       ...
       (5675, 1, CAST('2022-11-20' AS DATE), 466, 1, 4, 'APPLE', 'TABLETS', 'BEIGE',
        ...
        NULL, NULL, NULL, NULL, 'HUNDRED_TWENTY_EIGHT_GB', 'IPad Pro 11 ', 'IOS', 99.999, 'Apple A12X Bionic processor with 64 bit architecture', NULL,
       ...
       (6864, 1, CAST('2023-02-15' AS DATE), 737, 1, 5, 'SAMSUNG', 'TABLETS', 'BLACK',
        ...
        NULL, NULL, NULL, NULL, 'FIVE_HUNDRED_TWELVE_GB', 'Samsung Galaxy Tab S9 Ultra', 'ANDROID', 159.999, 'Qualcomm Snapdragon 8 Gen', NULL,
        NULL, '6.1', NULL, NULL, NULL),
       (2346, 2, CAST('2022-01-12' AS DATE), 172, 1, 6, 'APPLE', 'SMARTPHONES', 'GREY',
        'this product produced in 2022', NULL,
        NULL, NULL, NULL, NULL, 'HUNDRED_TWENTY_EIGHT_GB', 'IPhone 14 ', 'IOS', 86.999, 'Apple A15 Bionic', NULL,
        NULL, '6.1', NULL, NULL, NULL);
